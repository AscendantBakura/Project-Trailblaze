...
module TrainerGenerator_Settings
    ...
    BLACKLIST = [
        ...
        :MANAPHY, :PHIONE, :DARKRAI, :SHAYMIN, :ARCEUS, :COBALION, :TERRAKION, :VIRIZION, :TORNADUS, :THUNDURUS, :LANDORUS, :TYPENULL, :SILVALLY,
	:OKIDOGI, :MUNKIDORI, :FEZANDIPITI, :TAPUKOKO, :TAPULELE, :TAPUBULU, :TAPUFINI, :OGERPON, :TERAPAGOS, :PECHARUNT, :ZACIAN, :ZAMAZENTA,
	:REGIELEKI, :REGIDRAGO, :GLASTRIER, :SPECTRIER, :RESHIRAM, :ZEKROM, :KYUREM, :XERNEAS, :YVELTAL, :ZYGARDE, :COSMOG, :COSMOEM,
	:SOLGALEO, :LUNALA, :NECROZMA, :ETERNATUS, :CALYREX, :VICTINI, :KELDEO, :MELOETTA, :GENESECT, :DIANCIE, :HOOPA, :VOLCANION, :MIRAIDON, :KORAIDON,
	:MAGEARNA, :MARSHADOW, :ZERAORA, :MELTAN, :MELMETAL, :ZARUDE, :NAGANADEL, :ENAMORUS, :URSHIFU, :KUBFU
    ]
