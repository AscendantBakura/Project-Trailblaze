...
module TrainerClasses_Types
    ACETRAINER = {
        :TRAINERS => [:ACETRAINER_M,:ACETRAINER_F],
        :POWER => [450],
        :SPECIAL => [:VARIED]
    }
    AROMALADY = {
    ...
    BACKPACKER = {
        :TRAINERS => [:BACKPACKER_M,:BACKPACKER_F],
        :ONLYTYPE => [:NORMAL,:ROCK,:GROUND,:FLYING]
    }
    BATTLEGIRL = {
        :TRAINERS => [:SMASHER,:BATTLEGIRL],
        :ONLYTYPE => [:FIGHTING],
    ...
    BLACKBELT = {
        :TRAINERS => [:BLACKBELT,:STRIKER,:INFIELDER],
        :ONLYTYPE => [:FIGHTING]
    }
    BREEDER = {
        :TRAINERS => [:POKEMONBREEDER2],
        :SPECIAL => [:VARIED]
    }
    BUGCATCHER = {
    ...
    SCHOOLKID = {
        :TRAINERS => [:SCHOOLKID_M,:SCHOOLKID_F],
    ...
    SCIENTIST = {
        :TRAINERS => [:SCIENTIST2,:SCIENTIST1],
        :ONLYTYPE => [:PSYCHIC],
    ...
    WORKER = {
        :TRAINERS => [:WORKER,:WORKER_Snow],
        :ONLYTYPE => [:ROCK,:FIGHTING,:STEEL,:GROUND,:ICE]
    }
    YOUNGCOUPLE = {
        :TRAINERS => [:YOUNGCOUPLE]
    }
    YOUNGSTER = {
        :TRAINERS => [:YOUNGSTER1],
        :ONLYTYPE => [:BUG,:NORMAL]
