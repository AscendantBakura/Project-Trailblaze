...
class PokemonContest
	...
	def pbResults
		...
		pbMoveRoute(mcEvent,[PBMoveRoute::RIGHT,PBMoveRoute::RIGHT,PBMoveRoute::TURN_DOWN])
		pbMoveRoute(judgeEvent,[PBMoveRoute::LEFT,PBMoveRoute::LEFT,PBMoveRoute::TURN_DOWN])
...
class PokemonContestResults_Scene
	...
	def pbStartScene
		...
		@sprites["background"].setBitmap(sprintf("Graphics/UI/Contest/resultsbg"))
	...
	def pbShowIntroRoundBars
		...
		@maxX = []
		max = 320.0
		@sprites["barBitmap"] = AnimatedBitmap.new("Graphics/UI/Contest/overlay_results")
	...
	def pbShowPlaces
		...
		@sprites["first"].setBitmap(sprintf("Graphics/UI/Contest/result_first"))
		...
		@sprites["second"].setBitmap(sprintf("Graphics/UI/Contest/result_second"))
		...
		@sprites["third"].setBitmap(sprintf("Graphics/UI/Contest/result_third"))
		...
		@sprites["fourth"].setBitmap(sprintf("Graphics/UI/Contest/result_fourth"))
